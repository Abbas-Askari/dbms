  ...
  return (
    <div className='px-8 py-4 flex gap-2  items-center justify-between'>
        <Link href={'/products'} className="flex gap-2 items-center">
            <img src={favIcon.src} alt="" className='w-10 h-10 rounded-full border-white border-2' />
            <div className=" font-bold text-2xl">Zarad</div>
        </Link>

        
        <form action={searchProducts} className=" flex text-md items-center border-2 border-neutral-700 pl-6 pr-4 py-2 rounded-lg  focus-within:border-neutral-500    ">
            <input
                name='query'    
                type="text"
                className=' outline-none w-[400px] bg-inherit ' placeholder='Search for products...'/>
            <button>
